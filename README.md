...
The unified workspace organizes everything into five verb-named sections — **Health**, **Pipeline**, **Diagnose**, **Model & Edit**, and **Insights**. For a screen-by-screen inventory and the intended use cases behind each (brainstormed across five personas), see [docs/screen-inventory-and-use-cases.md](docs/screen-inventory-and-use-cases.md).
