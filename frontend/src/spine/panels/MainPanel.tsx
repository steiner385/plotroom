 ...
 *  + a discrete green/red/grey sparkline of the recent main-commit series, with a
 *  degrading-green trend arrow (#258) when the recent half is worse than the older. */
export function MainPanel({ repos }: { repos: DashboardState['repos'] }) {
  ...
  const trend = greenRateTrend(lh.mainSeries);
  return (
    <div className="spine-main-panel">
      <div className="spine-main-lastgreen">
        ...
        <TrendArrow trend={trend} baselineLabel="vs earlier" />
      </div>
